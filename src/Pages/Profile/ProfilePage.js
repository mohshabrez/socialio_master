...
export function ProfilePage(){
    ...
    const postsDe = posts.filter((post) => post.data.uid === currentUser.uid)
            ...
            <div className="profileImg">
                ...
                <div className="profileInfoo">
                    <div className="postsCount">
                        {getData && <span><strong>{postsDe.length} Posts</strong></span>}
                    </div>
            ...
            <div className="About">
                ...
                <div className="profile-btns">
                    <div className="btns-div">
                        ...
                        <button  className="btn btn-primary" onClick={()=>handleContact()}>Contact</button>
                        <button  className="btn btn-primary">Email</button>
                    </div>
                    {contact &&(
                           <div className="left">
                           <div className="notifications-popup">
                               <p>Contact: {getData?.data?.phoneNumber}</p>
                           </div>
                       </div>
                    ) 
                    }
