...
export function Stories(){
    ...
    return(
        <div className="stories">
            <a className="leftarrow" style={{marginLeft:"-3rem"}}><span class="material-symbols-outlined" style={{fontSize:"300%", color:"gray", position:"relative", top:"4rem", left:"1.5rem"}} onClick={prevSlide} disabled={startIndex === 0}>keyboard_double_arrow_left</span></a>
            ...
            <a className="rightarrow" style={{marginLeft:"1rem"}}><span class="material-symbols-outlined" style={{fontSize:"300%", position:"relative", top:"2rem" ,left:"-3rem", color:"gray"}} onClick={nextSlide} disabled={startIndex + 6  >= stories.length}>keyboard_double_arrow_right</span></a>
            {/* <div className="story">
                <div className="profile-photo">
